...
3. 根据 ECS 操作系统用对应的**命令**安装 “宝塔 Linux 面板”，复制 “**外网面板地址**”，进入面板（**注意**：需先配置 ECS 实例**安全组**，放行 **8888 端口**）
   ...
   2. 
   <figure>
     <img width="1339" height="179" src="/images/vue-node-mysql-deployment/1.png" alt="ecs-security-rules" />
     <figcaption>配置安全组规则</figcaption>
   </figure>
   3. 为了后续部署方便，通过**快速添加**为以下常用端口添加规则
   4. 
    <figure>
        <img width="897" height="628" src="/images/vue-node-mysql-deployment/2.png" alt="quick-add" />
...
<figure>
  <img width="977" height="601" src="/images/vue-node-mysql-deployment/3.png" alt="backend-dir" style={{zoom: .8}} />
