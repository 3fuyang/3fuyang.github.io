...
<img alt="Critical rendering path" src="/images/critical-rendering-path/render.png" aria-hidden="true" className="invertable" />
...
>
>不过，答案好像是 **No**。
><img alt="css-does-not-mutate-dom" src="/images/critical-rendering-path/css-mutate-dom.png" aria-hidden="true" className="invertable" />
>
