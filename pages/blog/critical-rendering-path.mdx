...
date: 2022-09-25T11:24:00.000+00:00
lang: zh
duration: 8min
...
<figure>
  <img width="729" height="207" alt="Critical rendering path" src="/images/critical-rendering-path/render.png" className="invertable" />
...
>不过，答案好像是 **No**。
><figure>
>  <img width="1073" height="679" alt="css-does-not-mutate-dom" src="/images/critical-rendering-path/css-mutate-dom.png" aria-hidden="true" className="invertable" />
