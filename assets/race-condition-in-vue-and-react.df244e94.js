...
`]})}),`
`,n(e.p,{children:"todo"})]})}function m(s={}){const{wrapper:e}=s.components||{};return e?n(e,Object.assign({},s,{children:n(c,s)})):c(s)}export{h as date,m as default,d as duration,r as lang,o as path,i as title};
