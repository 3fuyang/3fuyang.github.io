...
而不关注整个逻辑运算表达式所返回的结果。`]}),`
`,s.exports.jsxs(e.p,{children:["但总的来说，解开对逻辑运算符的这个误解还是对我帮助很大，能写出更简洁的程序不说，至少不会再",s.exports.jsx(e.strong,{children:"错误推断"}),"别人的代码了..."]})]})}function p(n={}){const{wrapper:e}=n.components||{};return e?s.exports.jsx(e,Object.assign({},n,{children:s.exports.jsx(r,n)})):r(n)}export{l as date,p as default,a as duration,c as lang,x as path,o as title};
