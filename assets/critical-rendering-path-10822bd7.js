...
`,e.exports.jsxs(s.p,{children:["因此，对 CSS 文件的",e.exports.jsx(s.strong,{children:"请求"}),"和",e.exports.jsx(s.strong,{children:"解析"}),"通常都是",e.exports.jsx(s.strong,{children:"阻塞"}),"渲染的，而且最重要的是，不完整的 CSSOM 会",e.exports.jsx(s.strong,{children:"阻塞 script 元素"}),"的加载。"]})]})}function p(r={}){const{wrapper:s}=r.components||{};return s?e.exports.jsx(s,Object.assign({},r,{children:e.exports.jsx(t,r)})):t(r)}export{c as date,p as default,i as duration,x as lang,l as path,o as title};
