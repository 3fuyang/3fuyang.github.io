...
f.`,s.exports.jsx(e.span,{className:"hljs-title function_",children:"myBind"}),"({",s.exports.jsx(e.span,{className:"hljs-attr",children:"a"}),": ",s.exports.jsx(e.span,{className:"hljs-number",children:"2"}),"})(",s.exports.jsx(e.span,{className:"hljs-number",children:"4"}),`)
`]})}),`
`,s.exports.jsxs(e.p,{children:["这样，所返回箭头函数的",s.exports.jsx(e.code,{children:"this"}),"将由",s.exports.jsx(e.code,{children:"myBind()"}),"在",s.exports.jsx(e.strong,{children:"运行时"}),"确定，也正好就是实例化的",s.exports.jsx(e.strong,{children:"函数对象"}),"。"]})]})}function x(n={}){const{wrapper:e}=n.components||{};return e?s.exports.jsx(e,Object.assign({},n,{children:s.exports.jsx(r,n)})):r(n)}export{t as date,x as default,c as duration,o as lang,p as path,a as title};
