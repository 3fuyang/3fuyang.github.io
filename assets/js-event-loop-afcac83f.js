...
`,s.exports.jsxs(e.p,{children:["上面的结果可以说明，一个执行上下文帧在执行栈中",s.exports.jsx(e.strong,{children:"保留"}),"并不代表 JS 代码",s.exports.jsx(e.strong,{children:"正在执行"}),"（mid-execution），关于作用域与上下文的知识，自己还需要更深入地了解。"]})]})}function a(r={}){const{wrapper:e}=r.components||{};return e?s.exports.jsx(e,Object.assign({},r,{children:s.exports.jsx(n,r)})):n(r)}export{o as date,a as default,x as duration,c as lang,i as path,l as title};
