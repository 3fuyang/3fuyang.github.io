...
`,e.exports.jsxs(s.p,{children:["可以看到，移除",e.exports.jsx(s.code,{children:"vite-plugin-pages"}),"后，应用的打包体积优化了整整...",e.exports.jsx(s.strong,{children:"64 KB"}),"！"]})]})}function h(r={}){return e.exports.jsx(t,Object.assign({},r,{children:e.exports.jsx(o,r)}))}export{x as date,h as default,l as description,p as duration,c as lang,d as path,n as title};
